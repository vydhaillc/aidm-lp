...
# ── the drawn procedure panels ─────────────────────────────────────────────
# Generated by tools/lp/illus.py. The card for a page's own offer reuses that
# page's "why it matters" photograph, so the two read as the same offer; the
# other two cards get the illustration for their procedure. Pages whose three
# cards are tiers of one treatment (wisdom teeth, full arch, dentures) get
# three illustrations that show what actually differs between the tiers.
ILLUS = dict((k, '../assets/illus/%s.svg' % k) for k in (
    'root-canal', 'crown', 'braces', 'aligner', 'early-ortho', 'implant-single',
    'exam', 'cleaning', 'emergency', 'wisdom-erupted', 'wisdom-impacted',
    'wisdom-bony', 'full-arch-4', 'full-arch-6', 'overdenture-2', 'overdenture-4'))
ALT = {
 'root-canal': 'Cross-section of a molar during root canal treatment: the infected pulp is removed from the canals and the tooth is sealed',
 'crown': 'A ceramic crown being seated onto a prepared, root-treated molar',
 'braces': 'Fixed orthodontic brackets bonded to the teeth with an archwire running through them',
 'aligner': 'A clear aligner tray seated over the arch of teeth',
 'early-ortho': 'A palatal expander fitted across a child&rsquo;s upper arch, widening it while the jaw is still growing',
 'implant-single': 'A single titanium dental implant placed in the jawbone, carrying an abutment and a ceramic crown',
 'exam': 'A mouth mirror and probe examining the teeth during a comprehensive dental examination',
 'cleaning': 'An ultrasonic scaler cleaning plaque and tartar from the teeth at the gum line',
 'emergency': 'A cracked molar with an abscess forming at the root tip',
 'wisdom-erupted': 'An erupted wisdom tooth being lifted from its socket with extraction forceps',
 'wisdom-impacted': 'An impacted wisdom tooth, tilted against the tooth in front with part of the crown still under the gum',
 'wisdom-bony': 'A complete-bony impacted wisdom tooth, fully enclosed in the jawbone',
 'full-arch-4': 'A fixed full-arch bridge carried on four dental implants',
 'full-arch-6': 'A fixed full-arch bridge carried on six dental implants',
 'overdenture-2': 'A removable implant-supported denture clipping onto two implants',
 'overdenture-4': 'A removable implant-supported denture clipping onto four implants',
}
...
def ortho_cards(feature, own_photo=None, own_alt=''):
    ...
    early = dict(img=ILLUS['early-ortho'], imgalt=ALT['early-ortho'], imgpos='center 52%',
    ...
    braces = dict(img=ILLUS['braces'], imgalt=ALT['braces'], imgpos='center 54%',
    ...
    invis = dict(img=ILLUS['aligner'], imgalt=ALT['aligner'], imgpos='center 50%',
...
''',
  ...
  opts=[dict(img=ILLUS['root-canal'], imgalt=ALT['root-canal'], imgpos='center 55%',
    ...
    dict(img=ILLUS['wisdom-erupted'], imgalt=ALT['wisdom-erupted'], imgpos='center 58%',
...
WISDOM = dict(
  ...
  opts=[dict(img=ILLUS['wisdom-erupted'], imgalt=ALT['wisdom-erupted'], imgpos='center 56%',
    ...
    dict(img=ILLUS['wisdom-impacted'], imgalt=ALT['wisdom-impacted'], imgpos='center 58%',
      ...
      fine='The package covers extractions only. Sedation and anaesthesia are billed separately.',
      cta='Book a consult'),
    dict(img=ILLUS['wisdom-bony'], imgalt=ALT['wisdom-bony'], imgpos='center 60%',
